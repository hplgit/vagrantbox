...
system('sudo apt-get -y install python-docutils')
system('sudo apt-get -y install python-sphinx')
system('sudo apt-get -y install python-pygments')
...
system('sudo apt-get -y install zenity')
# PyZenity must be installed from source
system('if [ ! -d srclib ]; then mkdir srclib; fi')
system('cd srclib')
system('svn checkout http://pyzenity.googlecode.com/svn/trunk/ pyzenity')
system('cd pyzenity')
