...
system('sudo pip install pyparsing')
...
system('sudo pip install Flask-WTF')
system('sudo pip install django')
system('sudo pip install progressbar')
...
system('sudo pip install memory_profiler')
system('sudo pip install line_profiler')
system('sudo pip install networkx')
system('sudo apt-get -y install python-dev')
...
# Do manual install instead (does not work with numpy v1.9 and beyond!)
#$ cd srclib
